      ...
      <div className="relative z-10 mx-auto max-w-3xl motion-safe:animate-in motion-safe:fade-in motion-safe:slide-in-from-bottom-4 motion-safe:duration-700">
        ...
        {ctaLabel && ctaUrl && (
          <div className="mt-10">
            <SectionLink
              href={ctaUrl}
              className="inline-flex items-center rounded-full bg-amber-300 px-8 py-4 text-base font-semibold text-slate-950 shadow-lg transition-all hover:bg-amber-200 hover:shadow-xl hover:scale-105 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-200 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-900 motion-safe:transition-transform"
            >
              {ctaLabel}
